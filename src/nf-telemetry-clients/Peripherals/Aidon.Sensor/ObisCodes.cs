namespace TelemetryStash.Aidon.Sensor
{
    public static class Obis
    {
        ...
        public static ObisCode ReactiveEnergyDraw = new("RED", "1-0:3.7.0", 8, "kvar");
        public static ObisCode ReactiveEnergyInput = new("REI", "1-0:4.7.0", 8, "kvar");
        ...
        public static ObisCode L1ReactiveEnergyDraw = new("1RD", "1-0:23.7.0", 8, "kvar");
        public static ObisCode L1ReactiveEnergyInput = new("1RI", "1-0:24.7.0", 8, "kvar");
        public static ObisCode L2ReactiveEnergyDraw = new("2RD", "1-0:43.7.0", 8, "kvar");
        public static ObisCode L2ReactiveEnergyInput = new("2RI", "1-0:44.7.0", 8, "kvar");
        public static ObisCode L3ReactiveEnergyDraw = new("3RD", "1-0:63.7.0", 8, "kvar");
        public static ObisCode L3ReactiveEnergyInput = new("3RI", "1-0:64.7.0", 8, "kvar");
