    ...
    CLR_UINT32 data[])
{
    ...
    {
        // Generic drivers only support up to 16-bit / two byte pixel formats.
        // Below adds support for 18-bit / three byte pixel formats by converting the 18-bit pixel data into 8-bit RGB components.
