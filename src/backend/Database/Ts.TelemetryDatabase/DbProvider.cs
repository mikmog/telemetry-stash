...
public interface IDbProvider
{
    ...
    Task<T?> QuerySingle<T>(Expression<Func<T, bool>> where, IEnumerable<OrderField>? orderBy = null, int? top = null, string? tableName = null, CancellationToken cancellationToken = default) where T : class;
    Task<IEnumerable<T>> QueryMultiple<T>(Expression<Func<T, bool>> where, string? tableName = null, CancellationToken cancellationToken = default) where T : class;
}
...
internal class DbProvider(string connectionString) : IDbProvider
{
    ...
    public async Task<T?> QuerySingle<T>(Expression<Func<T, bool>> where, IEnumerable<OrderField>? orderBy = null, int? top = null, string? tableName = null, CancellationToken cancellationToken = default) where T : class
    {
    ...
    public async Task<IEnumerable<T>> QueryMultiple<T>(Expression<Func<T, bool>> where, string? tableName = null, CancellationToken cancellationToken = default) where T : class
    {
        tableName ??= $"[dbo].[{typeof(T).Name}s]";
        using var connection = CreateConnection();
